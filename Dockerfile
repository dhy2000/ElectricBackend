...
# Write start script
RUN echo "java -jar SpringApplication.jar --spring.datasource.url=\$DB_ADDRESS_URL --spring.datasource.username=\$DB_USER --spring.datasource.password=\$DB_PASSWORD" >> serve.sh
